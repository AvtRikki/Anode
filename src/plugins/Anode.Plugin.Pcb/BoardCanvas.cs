...
/// Drawing is delegated to a Skia or OpenGL surface chosen by <see cref="GraphicsOptions.Renderer"/>.
/// </summary>
public sealed class BoardCanvas : Panel
{
    ...
    /// <summary>Zoom as a percentage of "one board millimetre is one pixel", for the tab summary.</summary>
    ...
    /// <summary>Camera moved: zoom or pan changed.</summary>
